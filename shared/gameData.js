...
const CHANCE_CARDS = [
  { text:'Advance to GO. Collect $200.', action:'goto', target:0, collect:true },
  { text:'Advance to Prestige Ave.', action:'goto', target:37 },
  { text:'Advance to Central Station.', action:'goto', target:5 },
  ...
  { text:'Advance to Apex Plaza.', action:'goto', target:34 },
...
if (typeof module !== 'undefined') {
  module.exports = { TOKENS, PLAYER_COLORS, COLOR_GROUPS, BOARD, GROUP_CELLS, CHANCE_CARDS, CHEST_CARDS };
}
